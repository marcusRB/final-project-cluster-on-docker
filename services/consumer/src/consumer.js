...
(async () => {
  ...
  kafkaConsumer.on('message', async function(message) {
    ...
    const insertResponse = await pgClient.query({
      text: 'INSERT INTO sales(uuid, total, sale_date, city, country, latitude, longitude) VALUES($1, $2, $3, $4, $5, $6, $7)',
      values: [uuidv4(), decodedMessage.total, saleDateISO8601, decodedMessage.city, 
        decodedMessage.country, decodedMessage.latitude, decodedMessage.longitude]
    });
